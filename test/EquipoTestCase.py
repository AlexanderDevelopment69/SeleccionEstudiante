...
class EquipoTestCase ( unittest.TestCase ) :
    def setUp ( self ) :
        ...
        self.equipo3 = Equipo(denominacionEquipo="Equipo3")

        self.session.add ( self.equipo1 )
        self.session.add ( self.equipo2 )
        self.session.add(self.equipo3)
    ...
    def test_agregar_equipo ( self ) :
        resultado = self.sorteo.agregar_equipo (denominacionEquipo = "Equipo3" )
        self.assertEqual (resultado , True )

    def test_agregar_equipo_repetido(self):
        resultado = self.sorteo.agregar_equipo(denominacionEquipo = "Equipo2")
