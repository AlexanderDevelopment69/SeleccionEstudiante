...
class ActividadTestCase ( unittest.TestCase ) :
 ...
 # Relacionar Asignatura con estudiantes
        ...
        self.equipo2.actividades = [ self.actividad3,self.actividad4 ]
        self.session.commit ( )
    ...
    def test_agregar_actividad ( self ) :
        resultado = self.sorteo.agregar_actividad ( nombreActividad = "Metodologìa SCRUM" )
        self.assertEqual ( resultado , True )

    def test_agregar_actividad_repetido(self):
        resultado = self.sorteo.agregar_actividad(nombreActividad = "Creación de ramas github")
